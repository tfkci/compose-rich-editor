...
class RichTextEditCorruptionFuzzTest {
    ...
    fun `fuzz with corruption oracles must find no new issues`() {
        ...
        for (seed in 0 until scenarios) {
            ...
            // The oracle models raw pipeline semantics; auto-capitalization after a
            // paragraph break would legitimately diverge from it.
            state.config.autoCapitalizeAfterParagraphBreak = false
